...
import { homeEmptyState, orderHomeAssignments } from "./assignmentHome";
...
export default function DashboardPage() {
  ...
  const empty = homeEmptyState(currentWorkspace.memberships.length, currentWorkspace.assignments.length);
  return <MainLayout>
    <header>
